 ...
 *		ExecCopySlot			- copy one slot's contents to another //CCKKKKKKKKKKKKKKKKK
 *
 *	 CONVENIENCE INITIALIZATION ROUTINES //CCKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK
