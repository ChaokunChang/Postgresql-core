...
DESCR(" jaccard_index ");
DATA(insert OID = 9999 (  levenshtein_distance1 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "25 25" _null_ _null_ _null_ _null_ _null_ levenshtein_distance1 _null_ _null_ _null_ ));
DESCR("levenshtein_distance1");
DATA(insert OID = 9998 (  levenshtein_distance2 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "25 25" _null_ _null_ _null_ _null_ _null_ levenshtein_distance2 _null_ _null_ _null_ ));
DESCR("levenshtein_distance2");
DATA(insert OID = 9997 (  levenshtein_distance3 PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "25 25" _null_ _null_ _null_ _null_ _null_ levenshtein_distance3 _null_ _null_ _null_ ));
DESCR("levenshtein_distance3");
